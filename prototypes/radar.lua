...
data:extend({
    ...
    },
    {
        ...
        integration_patch =
        {
            filename = "__castra-prime-assets__/graphics/entity/jammer-radar/radar-integration.png",
            priority = "low",
            width = 238,
            height = 216,
        ...
        pictures =
        {
            ...
            {
                {
                    filename = "__castra-prime-assets__/graphics/entity/jammer-radar/jammer-radar.png",
                    priority = "low",
                    width = 196,
                    height = 254,
                ...
                {
                    filename = "__castra-prime-assets__/graphics/entity/jammer-radar/radar-shadow.png",
                    priority = "low",
                    width = 336,
                    height = 170,
                    apply_projection = false,
        ...
        water_reflection =
        {
            pictures =
            {
                filename = "__castra-prime-assets__/graphics/entity/jammer-radar/radar-reflection.png",
                priority = "extra-high",
                width = 28,
                height = 32,
