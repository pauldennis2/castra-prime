...
Update: both of these should be fixed
...
Update: created an issue on K2SO github https://github.com/Polka37/Krastorio2-spaced-out/issues/153
...
Update: Understand this to be fixed. Notified author of new flag
...
Update: should be addressed; need to test. Tested, looks good
...
Update: hopefully addressed for new games, to be tested. Addressed - much better starting patch
...
Potential feature to be able to configure (maybe even stop?) the rate of enemy research. Done
